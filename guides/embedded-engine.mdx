...
API docs on [docs.rs](https://docs.rs/meradomo-engine), source at
[github.com/Meradomo/meradomo-engine](https://github.com/Meradomo/meradomo-engine):
...
An engine-bundled app can let its owner hand access to somebody else — from inside your
app, no browser, nothing extra to install. It is its own surface (a capability, four
endpoints, and the identity headers that tell your owner from your visitors):

<Card title="Share your app with other people" icon="users" href="/guides/sharing">
  Invite by email, list who has access, withdraw it.
</Card>
