...
The launcher/client is open source (MIT) — [github.com/Meradomo/meradomo-engine](https://github.com/Meradomo/meradomo-engine):

```toml
[dependencies]
meradomo-engine = { git = "https://github.com/Meradomo/meradomo-engine" }
```
